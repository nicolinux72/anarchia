...
import it.anarchia.microservices.shell.commands.ProjectCommand;
...
import it.anarchia.microservices.shell.commands.EntityCommand
import it.anarchia.microservices.shell.commands.NGServiceProxyCommand;
import it.anarchia.microservices.shell.commands.ProceduresCommand
import it.anarchia.microservices.shell.commands.ExecuteCommand
import it.anarchia.microservices.shell.commands.CheckInCommand
import it.anarchia.microservices.shell.commands.NGStateCommand
import it.anarchia.microservices.shell.commands.RestControllerCommand;
...
class DefaultCommandsRegistrar
{
    ...
    void register() {
        ...
        for (Command classname in [
                ...
                //nicola
                new ExecuteCommand(shell),
                new ProjectCommand(shell),
					 new CheckInCommand(shell),
                new ProceduresCommand(shell),
                new EntityCommand(shell),
                new RestControllerCommand(shell),
                new NGServiceProxyCommand(shell),
					 new NGStateCommand(shell)
